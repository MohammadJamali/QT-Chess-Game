...
Queen::Queen(Point<int>ChessMapLocation, int x, int y, int h, int w, Groups group, unsigned short id) : Chessman(ChessMapLocation, x, y, h, w, "Queen", group, id)
{
}

Matrix<int> Queen::getAvailablePlaces(Matrix<int> *map, bool)
{
